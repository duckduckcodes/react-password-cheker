...
var Match = function Match(_ref) {
  ...
  }, isMatch ? /*#__PURE__*/React__default.createElement("p", {
    style: display === 'color' ? valid_color : valid_line
  }, "password match") : /*#__PURE__*/React__default.createElement("p", {
...
var Rules = function Rules(_ref) {
  ...
  }, hasValidLength ? /*#__PURE__*/React__default.createElement("li", {
    style: display === 'color' ? valid_color : valid_line
  }, "between ", min, " and ", max, " character long") : /*#__PURE__*/React__default.createElement("li", {
    style: display === 'color' ? noValid_color : noValid_line
  }, "between ", min, " and ", max, " character long"), upper && /*#__PURE__*/React__default.createElement("div", null, hasUpperCase ? /*#__PURE__*/React__default.createElement("li", {
    style: display === 'color' ? valid_color : valid_line
  }, ' ', "uppercase character") : /*#__PURE__*/React__default.createElement("li", {
    style: display === 'color' ? noValid_color : noValid_line
  }, "uppercase character")), lower && /*#__PURE__*/React__default.createElement("div", null, hasLowerCase ? /*#__PURE__*/React__default.createElement("li", {
    style: display === 'color' ? valid_color : valid_line
  }, "lowercase character") : /*#__PURE__*/React__default.createElement("li", {
    style: display === 'color' ? noValid_color : noValid_line
  }, "lowercase character")), digits && /*#__PURE__*/React__default.createElement("div", null, hasDigit ? /*#__PURE__*/React__default.createElement("li", {
    style: display === 'color' ? valid_color : valid_line
  }, "1 digit") : /*#__PURE__*/React__default.createElement("li", {
    style: display === 'color' ? noValid_color : noValid_line
  }, "1 digit")), specialCharacter && /*#__PURE__*/React__default.createElement("div", null, hasSpecialChar ? /*#__PURE__*/React__default.createElement("li", {
    style: display === 'color' ? valid_color : valid_line
  }, "1 special character") : /*#__PURE__*/React__default.createElement("li", {
    style: display === 'color' ? noValid_color : noValid_line
  }, "1 special character"))));
};
